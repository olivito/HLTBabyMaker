# /users/olivito/dev_7_1_0/hadronic_basics/V3 (CMSSW_7_1_3)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "reHLT" )
process.load("HLTStudy.HLTBabyMaker.setup_tk1b_cff")
process.load("HLTStudy.HLTBabyMaker.babyMaker_cfi")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/olivito/dev_7_1_0/hadronic_basics/V3')
)
...
process.hltPrePFHTnocutPFMETnocutnocalocut = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
