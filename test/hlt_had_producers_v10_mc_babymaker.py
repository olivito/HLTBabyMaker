# /users/olivito/dev_8_0_0/had_producers/V10 (CMSSW_8_0_0_pre5)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "reHLT" )
process.load("HLTStudy.HLTBabyMaker.babyMaker_cfi")
process.load("HLTStudy.HLTBabyMaker.genInfoMaker_cfi")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/olivito/dev_8_0_0/had_producers/V10')
)
...
process.hltPreL1HTT75 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1HTT100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1HTT125 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_HTT125" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPreL1HTT125 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1HTT150 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1HTT175 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1HTT200 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1ETM50 = cms.EDFilter( "HLTLevel1GTSeed",
...
process.hltPreL1ETM50 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1ETM60 = cms.EDFilter( "HLTLevel1GTSeed",
...
process.hltPreL1ETM60 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sL1HTT100ORL1HTT125ORL1HTT150ORHTT175 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_HTT100 OR L1_HTT125 OR L1_HTT150 OR L1_HTT175" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPrePFHT350PFMET100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltAK4PFJetsTightIDCentral = cms.EDProducer( "HLTPFJetIDProducer",
    CEF = cms.double( 0.99 ),
    NHF = cms.double( 0.9 ),
    minPt = cms.double( 20.0 ),
    CHF = cms.double( 0.0 ),
...
process.hltAK4PFJetsTightIDCentralCorrected = cms.EDProducer( "CorrectedPFJetProducer",
    src = cms.InputTag( "hltAK4PFJetsTightIDCentral" ),
    correctors = cms.VInputTag( 'hltAK4PFCorrector' )
)
...
process.hltL1sL1ETM70ORETM60ORETM50ORDoubleJetC56ETM60 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETM70 OR L1_DoubleJetC56_ETM60 OR L1_ETM60 OR L1_ETM50" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPrePFMETNoMu90PFMHTNoMu90IDTight = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPFMETNoMu90 = cms.EDFilter( "HLTMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFMETNoMuProducer' ),
    minMht = cms.vdouble( 90.0 )
)
process.hltPrePFMET90PFMHT90IDTight = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sL1HTT75ORHTT100ORL1HTT125ORL1HTT150ORHTT175ORETM60ORETM50 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_HTT75 OR L1_HTT100 OR L1_HTT125 OR L1_HTT150 OR L1_HTT175 OR L1_ETM60 OR L1_ETM50" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPreHadProducers = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPFMETNoHFProducer = cms.EDProducer( "HLTMhtProducer",
    usePt = cms.bool( True ),
    minPtJet = cms.double( 0.0 ),
    jetsLabel = cms.InputTag( "hltAK4PFJets" ),
    minNJet = cms.int32( 0 ),
    maxEtaJet = cms.double( 3.0 ),
    excludePFMuons = cms.bool( False ),
    pfCandidatesLabel = cms.InputTag( "hltParticleFlow" )
)
process.hltPFMHTNoHF = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( True ),
    minPtJetHt = cms.double( 20.0 ),
    maxEtaJetMht = cms.double( 3.0 ),
    minNJetMht = cms.int32( 0 ),
    jetsLabel = cms.InputTag( "hltAK4PFJetsCorrected" ),
    maxEtaJetHt = cms.double( 3.0 ),
    minPtJetMht = cms.double( 20.0 ),
...
process.hltPFMHTTightIDCentral = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( False ),
    minPtJetHt = cms.double( 20.0 ),
    maxEtaJetMht = cms.double( 5.2 ),
    minNJetMht = cms.int32( 0 ),
    jetsLabel = cms.InputTag( "hltAK4PFJetsTightIDCentralCorrected" ),
    maxEtaJetHt = cms.double( 5.2 ),
    minPtJetMht = cms.double( 20.0 ),
    minNJetHt = cms.int32( 0 ),
    pfCandidatesLabel = cms.InputTag( "" ),
...
process.hltPFMHTNoHFTightIDCentral = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( False ),
    minPtJetHt = cms.double( 20.0 ),
    maxEtaJetMht = cms.double( 3.0 ),
    minNJetMht = cms.int32( 0 ),
...
process.HLTAK4PFJetsReconstructionSequence = cms.Sequence( process.HLTL2muonrecoSequence + process.HLTL3muonrecoSequence + process.HLTTrackReconstructionForPF + process.HLTParticleFlowSequence + process.hltAK4PFJets + process.hltAK4PFJetsLooseID + process.hltAK4PFJetsTightID + process.hltAK4PFJetsTightIDCentral )
...
process.HLTAK4PFJetsCorrectionSequence = cms.Sequence( process.hltFixedGridRhoFastjetAll + process.HLTAK4PFCorrectorProducersSequence + process.hltAK4PFJetsCorrected + process.hltAK4PFJetsLooseIDCorrected + process.hltAK4PFJetsTightIDCorrected + process.hltAK4PFJetsTightIDCentralCorrected )
...
process.HLT_L1HTT75 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT75 + process.hltPreL1HTT75 + process.HLTEndSequence )
process.HLT_L1HTT100 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT100 + process.hltPreL1HTT100 + process.HLTEndSequence )
process.HLT_L1HTT125 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT125 + process.hltPreL1HTT125 + process.HLTEndSequence )
process.HLT_L1HTT150 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150 + process.hltPreL1HTT150 + process.HLTEndSequence )
process.HLT_L1HTT175 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT175 + process.hltPreL1HTT175 + process.HLTEndSequence )
process.HLT_L1HTT200 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT200 + process.hltPreL1HTT200 + process.HLTEndSequence )
process.HLT_L1ETM50 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM50 + process.hltPreL1ETM50 + process.HLTEndSequence )
process.HLT_L1ETM60 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM60 + process.hltPreL1ETM60 + process.HLTEndSequence )
process.HLT_L1ETM70 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM70 + process.hltPreL1ETM70 + process.HLTEndSequence )
process.HLT_PFHT350_PFMET100_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT100ORL1HTT125ORL1HTT150ORHTT175 + process.hltPrePFHT350PFMET100 + process.HLTRecoMETSequence + process.hltMET75 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHT280 + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFMET100Filter + process.hltPFHT + process.hltPFHT350 + process.HLTEndSequence )
process.HLT_PFHT800_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT100ORL1HTT125ORL1HTT150ORHTT175 + process.hltPrePFHT800 + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHT650 + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT800 + process.HLTEndSequence )
process.HLT_PFMETNoMu90_PFMHTNoMu90_IDTight_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM70ORETM60ORETM50ORDoubleJetC56ETM60 + process.hltPrePFMETNoMu90PFMHTNoMu90IDTight + process.HLTRecoMETSequence + process.hltMET80 + process.HLTAK4CaloJetsSequence + process.hltMht + process.hltMHT80 + process.HLTAK4PFJetsSequence + process.hltPFMHTNoMuTightID + process.hltPFMHTNoMuTightID90 + process.hltPFMETNoMuProducer + process.hltPFMETNoMu90 + process.HLTEndSequence )
process.HLT_PFMET90_PFMHT90_IDTight_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM70ORETM60ORETM50ORDoubleJetC56ETM60 + process.hltPrePFMET90PFMHT90IDTight + process.HLTRecoMETSequence + process.hltMET70 + process.HLTAK4CaloJetsSequence + process.hltMht + process.hltMHT70 + process.HLTAK4PFJetsSequence + process.hltPFMHTTightID + process.hltPFMHTTightID90 + process.hltPFMETProducer + process.hltPFMET90 + process.HLTEndSequence )
process.HLT_Had_Producers_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT75ORHTT100ORL1HTT125ORL1HTT150ORHTT175ORETM60ORETM50 + process.hltPreHadProducers + process.HLTRecoMETSequence + process.HLTHBHENoiseCleanerSequence + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltMht + process.hltMetClean + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFMETNoMuProducer + process.hltPFMETNoHFProducer + process.hltPFHT + process.hltPFMHTNoHF + process.hltPFMHTTightID + process.hltPFMHTTightIDCentral + process.hltPFMHTNoHFTightIDCentral + process.hltPFMHTNoMuTightID + process.HLTEndSequence + process.babyMaker )
...
process.genInfoPath = cms.Path( process.genInfoMaker )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_L1HTT75, process.HLT_L1HTT100, process.HLT_L1HTT125, process.HLT_L1HTT150, process.HLT_L1HTT175, process.HLT_L1HTT200, process.HLT_L1ETM50, process.HLT_L1ETM60, process.HLT_L1ETM70, process.HLT_PFHT350_PFMET100_v1, process.HLT_PFHT800_v2, process.HLT_PFMETNoMu90_PFMHTNoMu90_IDTight_v1, process.HLT_PFMET90_PFMHT90_IDTight_v2, process.HLT_Had_Producers_v1, process.HLTriggerFinalPath, process.genInfoPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/mc/RunIIFall15DR76/SMS-T1bbbb_mGluino-1000_mLSP-900_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/GEN-SIM-RAW/25nsFlat10to50NzshcalRaw_76X_mcRun2_asymptotic_v12-v1/70000/CE083DB1-52B0-E511-95C5-0CC47A78A32E.root',
    ),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '80X_mcRun2_asymptotic_ForTSGStudies_v1')
...
process.out = cms.OutputModule(
        "PoolOutputModule",
        fileName     = cms.untracked.string('ntuple_v10_T1bbbb_1000_900_savejets_100.root'),
...
_customInfo['globalTag' ]= "80X_mcRun2_asymptotic_ForTSGStudies_v1"
_customInfo['inputFile' ]=  ['/store/mc/RunIIFall15DR76/SMS-T1bbbb_mGluino-1000_mLSP-900_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/GEN-SIM-RAW/25nsFlat10to50NzshcalRaw_76X_mcRun2_asymptotic_v12-v1/70000/CE083DB1-52B0-E511-95C5-0CC47A78A32E.root']
